...
var eventHandlers = {
  shortcutKey: function shortcutKey(command) {
  ...
  contextMenu: function contextMenu(info, tab) {
    var title, url;
  ...
  HTTPrequestHandler: function HTTPrequestHandler(args) {
...
var utils = {
  isDuplicated: function isDuplicated(url) {
    var r = false;
  ...
  undefinedResolver: function undefinedResolver() {
...
var storageUpdater = {
  appendItem: function appendItem(title, url, target) {
    var Items = [];
  ...
  callback_appendSync: function callback_appendSync(title, url, data) {
  ...
  eliminateItem: function eliminateItem(title, target) {
    var Items = [];
  ...
  callback_eliminateSync: function callback_eliminateSync(title, data) {
    if (chrome.runtime.lastError) {
      return;
    }
