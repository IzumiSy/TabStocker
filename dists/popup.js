...
(function () {
  var FAVICON_API = "http://favicon.hatena.ne.jp/?url=";
  var ITEMS_SYNC_TAB = 0;
  var ITEMS_LOCAL_TAB = 1;
  ...
  var isArrayValid = function isArrayValid(n) {
  ...
  var stockItems = {
    ...
    appendSync: function appendSync(tab) {
    ...
    execute: function execute(array, title) {
    ...
    restore: {
      localItems: function localItems() {
        var items = [];
    ...
    reorder: function reorder(array) {
    ...
    orderedSave: function orderedSave() {
      var items;
      var orderedItems;
    ...
    applyUI: {
      eliminateItem: function eliminateItem(index, tab) {
        $("#" + tab + " li:eq(" + index + ")").hide(100, function () {
          item.remove();
        });
      },

      appendItem: function appendItem(title, url, tab) {
  ...
  var popupBodyHandlers = {
    ...
    tabSwitch: function tabSwitch(event, ui) {
